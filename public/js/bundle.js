...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZnJhbnNwZXJra29sYSIsImEiOiJjbDZmN2s2eWMwZXM5M29yd3pnYnN5aGlxIn0.fSqOfI7Rw4vIoswpGIt9Ww";
  var map = new mapboxgl.Map({
    container: "map",
    // container ID
    style: "mapbox://styles/fransperkkola/cl6f8ezll004916pkuzf4ybjb",
    // style URL
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === "password" ? "/api/v1/users/updatePassword" : "http://127.0.0.1:3000/api/v1/users/updateMe";
            console.log(data);
            _context.next = 5;
            return (0, _axios.default)({
              method: "PATCH",
          ...
          case 5:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "".concat(type, " updated succesfully!")); //location.reload(true);
            }
...
var stripe = Stripe('pk_test_51MIBQyIZBKGC8fZm7VJYJfm282Vn6TSxSUG6Qzr6XA8XKwJ3bs5MhL9xwiKh6Netmu15aUkf1rXPxZGn64YRRso000rMXz4LHF');
